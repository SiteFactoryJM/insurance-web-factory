...
운영 사이트에는 제작 도구·갤러리·제안 화면을 노출하지 않습니다. `/studio/advanced`는 데모용 경로 분리이지 로그인이나 권한 제어 시스템이 아닙니다.
...
문구 선택 시 PC와 모바일 원고가 함께 설정됩니다. 현재 라이브러리는 두 화면에서 완전한 문장을 제공하도록 짧은 원고를 사용하며 임의 잘라내기를 하지 않습니다. 자유 편집에서 별도로 다듬을 수 있습니다.
