...
import { directPhoneHref, openChatUrl } from '../.preview-dist/utils/contact-links.js';
...
test('blank project does not silently copy a real advisor identity',()=>{
 const s=blankGuidedSite(raw);for(const v of [s.agent.name,s.agent.company,s.contact.phone,s.contact.kakaoUrl,s.contact.availableHours])assert.equal(v,'');
