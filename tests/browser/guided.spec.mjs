...
test('all five layout choices change the visible page structure while keeping its palette',async({page})=>{
 await start(page);
 const layouts={
  'trust-blue':{hero:'hero-portrait',services:'services-list',about:'about-editorial',sections:['home','cases','specialties','insurance-scope','about','process','faq','contact']},
  'warm-care':{hero:'hero-portrait',services:'services-cards',about:'about-profile',sections:['home','cases','about','specialties','insurance-scope','faq','process','contact']},
  'premium-navy':{hero:'hero-statement',services:'services-split',about:'about-editorial',sections:['home','cases','specialties','insurance-scope','process','about','faq','contact']},
  'clean-minimal':{hero:'hero-statement',services:'services-cards',about:'about-editorial',sections:['home','cases','specialties','insurance-scope','process','faq','about','contact']},
  'local-friendly':{hero:'hero-editorial',services:'services-cards',about:'about-editorial',sections:['home','cases','specialties','insurance-scope','contact','faq','about','process']},
 };
