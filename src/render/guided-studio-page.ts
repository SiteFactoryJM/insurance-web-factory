...
.g-intro{padding:1.5rem 2rem 1rem;max-width:1440px;margin:auto}.g-kicker{font-size:.9rem;color:#526170;margin:0 0 .5rem}.g-intro>p:last-child{max-width:800px;color:#526170}
.g-layout{display:grid;grid-template-columns:minmax(720px,920px) minmax(360px,1fr);max-width:1440px;margin:auto;border-top:1px solid #cdd6e0}
.g-editor{min-width:0;padding:2rem;display:grid;grid-template-columns:200px minmax(0,1fr);column-gap:32px;align-content:start;background:#f8f7f3}
...
.g-section{margin-top:2rem;padding-top:1.5rem;border-top:1px solid #cdd6e0}
