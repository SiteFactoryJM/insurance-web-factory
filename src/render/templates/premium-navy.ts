...
export function renderPremiumNavyHero(site: SiteConfig, actions: string, profile: string): string {
  return `<section class="hero hero-premium-navy" id="home">
    <div class="premium-grid" aria-hidden="true"></div>
