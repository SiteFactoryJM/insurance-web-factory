...
.floating-contact-dock{position:fixed;z-index:90;right:max(18px,env(safe-area-inset-right));top:75%;transform:translateY(-50%);display:flex;flex-direction:column;gap:10px;padding:8px;border:1px solid var(--line);background:var(--paper);box-shadow:0 12px 32px rgba(15,23,42,.16);backdrop-filter:blur(10px);border-radius:999px}
