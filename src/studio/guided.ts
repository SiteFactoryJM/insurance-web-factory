...
const preview = document.getElementById('studio-preview') as HTMLElement;
const mat = document.querySelector('.s-mat') as HTMLElement;
const canvas = document.querySelector('.s-canvas') as HTMLElement;
