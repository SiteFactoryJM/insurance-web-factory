...
const siteRule = object({
  ...
  footer: object({ heading: text(80, true), note: text(400, true), hideInstagram: bool(true) }, true),
  ...
  hero: object({ eyebrow: text(80, true), headline: text(40), subheadline: text(120), mobileHeadline: text(24, true, 1), mobileSubheadline: text(60, true, 1),
    ...
    certificationBadgeImage: imageRule(true), certificationBadgeAlt: text(100, true) }),
  ...
  sections: object({ career: bool(), process: bool(), reviews: bool(true), faq: bool(), location: bool(), contactForm: bool(), recruitment: bool(true) }),
