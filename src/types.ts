...
export interface SiteConfig {
  ...
  compliance: {
    ...
    advertisingReviewNumber?: string;
    advertisingReviewExpiresAt?: string;
    footerDisclaimer: string;
    privacyOfficer: string;
    privacyRetentionPeriod: string;
    contentTruthConfirmed: boolean;
    photoUseConfirmed: boolean;
    publicationConfirmed: boolean;
  };
  demo?: {
    enabled: boolean;
    allowTemplateSwitch?: boolean;
    submissionMode?: "discard" | "store";
  };
}
